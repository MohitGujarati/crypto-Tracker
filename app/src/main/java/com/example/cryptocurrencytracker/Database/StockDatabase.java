package com.example.cryptocurrencytracker.Database;
...
@Database(entities = {StockModel.class}, version = 2)
public abstract class StockDatabase extends RoomDatabase {


    //The saved data that the system uses to restore the previous state is called the instance
